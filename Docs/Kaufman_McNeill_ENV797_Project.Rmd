...
#auto sarima with monthly LT2 series
LT2_auto <- auto.arima(ts_LT2_monthly_clean)
summary(LT2_auto)

#auto sarima with monthly SAL series
SAL_auto <- auto.arima(ts_SAL_monthly_clean)
summary(SAL_auto)
...
ETS_LT2 <-  ets(LT2_daily_training, h = 365)
...
ETS_SAL <-  ets(SAL_daily_training, h = 365)
