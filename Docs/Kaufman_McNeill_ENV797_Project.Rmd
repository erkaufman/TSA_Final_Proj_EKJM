...
```{r import data, echo=FALSE, fig.cap="Raw", warning=FALSE}
...
```{r data head and data variables kable, warning=FALSE, echo=FALSE}
...
```{r clean time series, echo=FALSE, warning=FALSE, fig.cap="Depth to Groundwater Time Series"}
...
```{r , echo=FALSE, warning=FALSE, fig.cap="LT2 and SAL Time Series"}
...
```{r correlation plots, echo=FALSE, warning=FALSE, fig.cap="Depth to Groundwater Correlation"}
...
```{r ACF and PACF for LT2, echo=FALSE, warning=FALSE, fig.cap="ACF and PACF for Depth to Groundwater at Well LT2"}
...
```{r ACF and PACF for SAL, echo=FALSE, warning=FALSE, fig.cap="ACF and PACF for Depth to Groundwater at Well SAL"}
...
```{r deseasoned time series plot to show trend, echo=FALSE, warning=FALSE, fig.cap="Trend Visualization for Deseasoned Time Series of Depth to Groundwater at Wells LT2 and SAL"}
...
```{r compare accuracy for all SARIMAs, warning=FALSE, echo=FALSE}
...
The seasonal auto arima for well LT2 (confined) had p,d,q of ___. 

The seasonal auto arima for well SAL (unconfined) had p,d,q of ___. 
