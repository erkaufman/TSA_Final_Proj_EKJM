...
LT2_scores <- as.data.frame(rbind(auto_LT2_scores, ETS_LT2_scores, #EMMA, #EMMA))
row.names(LT2_scores) <- c("SARIMA", "ETS", #"EMMA", #"EMMA")

#create data frame for SAL scores
SAL_scores <- as.data.frame(rbind(auto_SAL_scores, ETS_SAL_scores, #EMMA, #EMMA))
row.names(SAL_scores) <- c("SARIMA", "ETS", #"EMMA", #"EMMA")
