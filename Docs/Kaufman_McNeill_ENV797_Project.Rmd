...
kbl(head_auser[,1:5], col.names = NULL, caption="Auser Aquifer Data Head Rows 1-5") %>%
  kable_styling(font_size = 10,
                full_width = FALSE)

kbl(head_auser[,6:10], col.names = NULL, caption="Auser Aquifer Data Head Rows 6-10") %>%
  kable_styling(font_size = 10,
                full_width = FALSE)
```
...
```{r deseasoned time series plot to show trend, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Trend Visualization for Deseasoned Time Series of Depth to Groundwater at Wells LT2 and SAL"}
