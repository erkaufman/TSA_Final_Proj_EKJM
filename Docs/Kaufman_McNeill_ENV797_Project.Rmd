...
```{r correlation plots, echo=FALSE, fig.cap="Figure 3. Depth to Groundwater Correlation"}
...
```{r ACF and PACF for LT2, echo=FALSE, fig.cap="Figure 4. ACF and PACF for Depth to Groundwater at Well LT2"}
...
```{r ACF and PACF for SAL, echo=FALSE, fig.cap="Figure 5. ACF and PACF for Depth to Groundwater at Well SAL"}
...
```{r decomposition LT2, echo=FALSE, fig.cap="Figure 6. Decomposition of Depth to Groundwater at Well LT2"}
...
```{r decomposition SAL, echo=FALSE, fig.cap="Figure 7. Decomposition of Depth to Groundwater at Well SAL"}
...
```{r trend tests for LT2 and SAL, include=FALSE}
...
```{r deseasoned time series plot to show trend, echo=FALSE, fig.cap="Figure 8. Trend Visualization for Deseasoned Time Series of Depth to Groundwater at Wells LT2 and SAL"}
...
```{r monthly average data wrangling, include=FALSE}
...
```{r subset monthly time series, include=FALSE}
...
```{r subset daily time series, include=FALSE}
...
```{r SSES Model LT2 and SAL, include=FALSE}
...
```{r NN Model LT2 and SAL, include=FALSE}
...
```{r Comparing Performance Metrics, echo=FALSE}
...
```{r plot the model fits, echo=FALSE, fig.cap="Figure 9. Model Fit Comparisons for Well LT2"}
...
```{r plot the test zone, echo=FALSE, fig.cap="Figure 10. Model Fit Comparisons for Well SAL"}
...
```{r create monthly exogenous variables for Sarima, include=FALSE}
...
```{r create training and testing sets with the exogenous variables, include=FALSE}
...
```{r Sarima with exogenous variables for LT2, include=FALSE}
...
```{r Sarima with exogenous variables for SAL, include=FALSE}
...
```{r compare accuracy for all SARIMAs, echo=FALSE}
...
```{r SARIMA comparison plots, echo=FALSE, fig.cap="Figure 11. SARIMA Model Improvements when Exogenous Variables are Included at Wells LT2 and SAL"}
